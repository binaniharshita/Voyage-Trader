...
<%Map<ReservationBean,List<PassengerBean>> al=(Map<ReservationBean,List<PassengerBean>>)session.getAttribute("selectedReservation"); %>
<%
ReservationBean rb=new ReservationBean();
List<PassengerBean> pb=null;
for (Map.Entry<ReservationBean,List<PassengerBean>> me : al.entrySet()) {
        rb=me.getKey();
		pb=me.getValue();
    }
%>

...
<%double amt = (double)session.getAttribute("reservation_totalamt"); %>

<%int n = (int)session.getAttribute("noofseats");%>
<!DOCTYPE html>
<html>
<head>
...
<div id="main">
  ...
  <form:form action="newPassenger" method="POST" modelAttribute="passenger">
            <c:forEach items="${passenger.passengers}" varStatus="status" var="ps">
            <div class="card card-4">
                <div class="card-body">
                    
                    <p>Passenger ${status.index+1}</p>
                   <!-- <form:input type="text" path="passengers[${status.index}].schedule.scheduleid" hidden="true"/>
                    -->
                        <div class="input-group">
                            <label class="label">Name</label>
                            <form:input path="passengers[${status.index}].name" class="input--style-4" type="text"/>
                        </div>
                        <div class="input-group">
                            <label class="label">Age</label>
                            <form:input type="text" class="input--style-4" path="passengers[${status.index}].age" />
                        </div>
                        <div class="input-group">
                            <label class="label">Gender</label>
                            <form:input type="text" class="input--style-4" path="passengers[${status.index}].gender" />
                        </div>
                  ...
                  <div class="input-group">
                            ...
                            <input class="input--style-4" type="text" name="creditcardnumber" required>
                        </div>

<%@page import="com.danskeit.srs2.bean.CreditCardBean"%>
<%@page import="com.danskeit.srs2.*" %>
<%@page import="java.util.*" %>
<%CreditCardBean ccb=(CreditCardBean)request.getAttribute("cardDetails"); %>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="card-body">
                    ...
                    <input type="text" name="userid" hidden="true" value="<%=id%>">
                        <div class="input-group">
                            ...
                            <input class="input--style-4" type="text" name="creditcardnumber" value="<%=ccb.getCreditcardnumber()%>" required>
                        </div>
                        <div class="input-group">
                            <label class="label">Valid From</label>
                            <input class="input--style-4" type="date" name="validfrom" value="<%=ccb.getValidfrom()%>" required>
                        </div>
                        <div class="input-group">
                            <label class="label">Valid To</label>
                            <input class="input--style-4" type="date" name="validto" value="<%=ccb.getValidto()%>" required>
                        </div>
                        <div class="input-group">
                            <label class="label">Balance</label>
                            <input class="input--style-4" type="text" name="balance" value="<%=ccb.getBalance()%>" required>
                        </div>
                        <div class="p-t-15">

...
<%ArrayList<ShipBean> al=(ArrayList<ShipBean>)request.getAttribute("aaa"); %>
  <!DOCTYPE html>
<html>
<head>
     ...
     <table id="t01">
        <tr>
                ...
                <tr>
                  ...
                  <td>
                  <form action="modById">
                  <button name="shipid" value="<%=sb.getShipid() %>" type="submit" class="btn btn--radius-2 btn--blue">Update</button>
                  </form>
                  </td>
                  </tr> 
              <%} %>

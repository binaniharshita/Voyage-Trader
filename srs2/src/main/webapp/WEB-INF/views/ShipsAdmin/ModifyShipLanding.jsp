...
<%ShipBean sb=(ShipBean)request.getAttribute("selectedShipModify"); %>
<!doctype html>
<html lang="en">
<head>
  ...
  <div class="container-login100">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form action="editShip">
                    <input class="input--style-4" type="text" name="shipid" value="<%=sb.getShipid()%>" hidden="true">
                        <div class="input-group">
                            <label class="label">Ship Name</label>
                            <input class="input--style-4" type="text" name="shipname" value="<%=sb.getShipname()%>" required>
                        </div>
                        <div class="input-group">
                            <label class="label">Seating Capacity</label>
                            <input class="input--style-4" type="text" name="seatingcapacity" value="<%=sb.getSeatingcapacity() %>" required>
                        </div>
                        <div class="input-group">
                            <label class="label">Reservation Capacity</label>
                            <input class="input--style-4" type="text" name="reservationcapacity" value="<%=sb.getReservationcapacity()%>" required>
                        </div>
                        <div class="p-t-15">

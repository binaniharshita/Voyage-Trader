  ...
  <h2></h2>
      <div class="container-login100">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Enter Route Details</h2>

                    <form action="newRoute">
                    
                        <div class="input-group">
                            <label class="label">Source</label>
                            <input class="input--style-4" type="text" name="source" required>
                        </div>
                        <div class="input-group">
                            <label class="label">Destination </label>
                            <input class="input--style-4" type="text" name="destination" required>
                        </div>
                        <div class="input-group">
                            <label class="label">Travel Duration in Hours</label>
                            <input class="input--style-4" type="text" name="travelduration" required>
                        </div>
                        <div class="input-group">
                            <label class="label">Fare</label>
                            <input class="input--style-4" type="text" name="fare" required>
                        </div>
                        <div class="p-t-15">

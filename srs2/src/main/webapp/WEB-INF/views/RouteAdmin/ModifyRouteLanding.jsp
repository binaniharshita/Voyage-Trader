     ...
     <div class="container-login100">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <input type="text" style:display="none" name="routeid" value=<%=rb.getRouteid()%>>
                        <div class="input-group">
                            <label class="label">Source</label>
                            <input class="input--style-4" type="text" name="source" value=<%=rb.getSource() %> required>
                        </div>
                        <div class="input-group">
                            <label class="label">Destination </label>
                            <input class="input--style-4" type="text" name="destination" value=<%=rb.getDestination() %> required>
                        </div>
                        <div class="input-group">
                            <label class="label">Travel Duration in Hours</label>
                            <input class="input--style-4" type="text" name="travelduration" value=<%=rb.getTravelduration() %> required>
                        </div>
                        <div class="input-group">
                            <label class="label">Fare</label>
                            <input class="input--style-4" type="text" name="fare" value=<%=rb.getFare() %> required>
                        </div>
                        <div class="p-t-15">

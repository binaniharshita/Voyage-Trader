...
<%ArrayList<RouteBean> al=(ArrayList<RouteBean>)session.getAttribute("aaa"); %>
<!doctype html>
<html lang="en">
<head>
     ...
     <table id="t01">
        <tr>
                ...
                <tr>
                  <td><%=rb.getRouteid() %></td>
                  <td><%=rb.getSource() %></td>
                  <td><%=rb.getDestination() %></td>
                  <td><%=rb.getTravelduration() %></td>
                  <td><%=rb.getFare() %></td>
                  <td>
                  <form action="delByIdRoute">
                  <button name="routeid" value="<%=rb.getRouteid() %>" type="submit" class="btn btn--radius-2 btn--blue">Delete</button>
                  </form>
                </td>
                  </tr> 
              <%} %>

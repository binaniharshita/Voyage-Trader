...
<%ArrayList<ShipBean> sal=(ArrayList<ShipBean>)request.getAttribute("ships"); %>
<%ArrayList<RouteBean> ral=(ArrayList<RouteBean>)request.getAttribute("routes"); %>
<!doctype html>
<html lang="en">
<head>
...
<div id="main">
  ...
  <div class="container-login100">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Enter Schedule Details</h2>

                    <form action="newSchedule">
                    
                        <div class="input-group">
                            <label class="label">Ship Id</label>
                            <!--<input class="input--style-4" type="text" name="shipid" required>-->
                            <select class="input--style-4" name="shipid">
                            <%for(ShipBean sb:sal){%>
                            <option value="<%=sb.getShipid()%>"><%=sb.getShipid()%></option>
                            <%}%>
                            </select>
                        </div>
                        <div class="input-group">
                            <label class="label">Route Id</label>
                            <!--<input class="input--style-4" type="text" name="routeid" required>-->
                            <select class="input--style-4" name="routeid">
                            <%for(RouteBean rb:ral){%>
                            <option value="<%=rb.getRouteid()%>"><%=rb.getRouteid()%></option>
                            <%}%>
                            </select>
                        </div>
                        <div class="input-group">
                            <label class="label">Start Date</label>
                            <input class="input--style-4" type="date" name="startdate" required>
                        </div>
                        <div class="p-t-15">

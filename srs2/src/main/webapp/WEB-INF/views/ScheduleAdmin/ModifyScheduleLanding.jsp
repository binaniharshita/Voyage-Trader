...
<%ArrayList<ScheduleBean> al=(ArrayList<ScheduleBean>)request.getAttribute("selectedschedule"); %>
<%ScheduleBean sb = al.get(0);%>
<!doctype html>
<html lang="en">
<head>
            ...
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form action="editSchedule">
                    	<input type="text" style:display="none" name="scheduleid" value=<%=sb.getScheduleid()%>>
                        <div class="input-group">
                            <label class="label">Ship Id</label>
                            <input class="input--style-4" type="text" name="shipid" value=<%=sb.getShip().getShipid() %> required>
                        </div>
                        <div class="input-group">
                            <label class="label">Route Id</label>
                            <input class="input--style-4" type="text" name="routeid" value=<%=sb.getRoute().getRouteid() %> required>
                        </div>
                        <div class="input-group">
                            <label class="label">Start Date</label>
                            <input class="input--style-4" type="date" name="startdate" value=<%=sb.getStartdate() %> required>
                        </div>
                        <div class="p-t-15">

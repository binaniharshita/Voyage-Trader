     ...
     <table id="t01">
        <tr>
                ...
                <tr>
                  ...
                  <td><%=sb.getShip().getShipid() %></td>
                  <td><%=sb.getRoute().getRouteid() %></td>
                  <td><%=sb.getStartdate() %></td>
                   <td>
                  <form action="delByIdSchedule">
                  <button name="scheduleid" value="<%=sb.getScheduleid() %>" type="submit" class="btn btn--radius-2 btn--blue">Delete</button>
                  </form>
                </td>
                  </tr> 
              <%} %>

...
<div class="sidenav" id="mySidenav">
  ...
  <div class="dropdown-container4">
    ...
    <a href="customer/changePassCustomer">Change Password</a>
    <a href="logout">Logout</a>
  </div>
  
    <a href="customer/viewSchedule">New Reservation</a>
    <a href="customer/viewAllReservation">View All Reservations</a>
    <a href="customer/viewReservation">View Reservation By ID</a>
    <a href="customer/deleteReservation">Delete Reservation</a>

    <a href="customer/printTicket">Print Ticket</a>
